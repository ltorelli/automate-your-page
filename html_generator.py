...
def get_section_by_number(text, section_number):
    ...
    while counter < section_number:
        ...
        next_section_end   = text.find('Section', next_section_start + 1)
